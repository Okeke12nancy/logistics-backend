...
export interface ApiLogisticsAppUserLogisticsAppUser
  extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Role: Attribute.Enumeration<
      ['Admin', 'Logistics Manager', 'Driver', 'Customer']
    >;
    Password: Attribute.Password;
    Email: Attribute.Email;
...
export interface ApiShipmentShipment extends Schema.CollectionType {
  ...
  attributes: {
    ...
    ETA: Attribute.DateTime;
    Status: Attribute.Enumeration<['In Transit', 'Delivered']>;
    trackingHistory: Attribute.JSON;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::logistics-app-user.logistics-app-user': ApiLogisticsAppUserLogisticsAppUser;
